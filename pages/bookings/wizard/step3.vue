  ...
  const submitForm = () => {
    ...
    const updatedData = {...props.data, paymentMethod: paymentInfo.value.paymentMethod, note: paymentInfo.value.note}
      ...
      <div class="we-content">
        ...
        <form @submit.prevent="submitForm" class="we-form">
          <FormGroup :for="'paymentMethod'" :label="'Payment Method'" :error="errors.paymentMethod">
            <select v-model="paymentInfo.paymentMethod" id="paymentMethod" class="we-input">
          ...
          <FormGroup :for="'note'" :label="'Note (Optional)'">
            <textarea v-model="paymentInfo.note" id="note" class="we-input"></textarea>
          </FormGroup>
